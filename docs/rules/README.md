...
| [regexp/no-potentially-empty-backreference](./no-potentially-empty-backreference.md) | disallow backreferences that reference a group that might not be matched |  |

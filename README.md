...
| [regexp/no-standalone-reverse-solidus](https://ota-meshi.github.io/eslint-plugin-regexp/rules/no-standalone-reverse-solidus.html) | disallow standalone reverse solidus (`\`) |  |

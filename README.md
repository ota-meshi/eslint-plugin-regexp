...
| [regexp/no-potentially-empty-backreference](https://ota-meshi.github.io/eslint-plugin-regexp/rules/no-potentially-empty-backreference.html) | disallow backreferences that reference a group that might not be matched |  |

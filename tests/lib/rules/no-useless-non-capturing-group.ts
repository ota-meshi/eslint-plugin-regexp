...
tester.run("no-useless-non-capturing-group", rule as any, {
    valid: [
        ...
        `/{2,(?:5)}/.test(str)`,
        `/a{(?:5})/.test(str)`,
        String.raw`/\u{(?:41)}/.test(str)`,
        String.raw`/(.)\1(?:2\s)/.test(str)`,
        String.raw`/\0(?:2)/.test(str)`,
        String.raw`/\x4(?:1)*/.test(str)`,
        String.raw`/\x4(?:1)/.test(str)`,
        String.raw`/(?:\x4)1/.test(str)`,
        String.raw`/\x(?:4)1/.test(str)`,
        String.raw`/\x(?:41\w+)/.test(str)`,
        String.raw`/\u004(?:1)/.test(str)`,
        String.raw`/\u00(?:4)1/.test(str)`,
        String.raw`/\u0(?:0)41/.test(str)`,
        String.raw`/\u(?:0)041/.test(str)`,
